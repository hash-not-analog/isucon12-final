...
ALTER TABLE `user_present_all_received_history` ADD INDEX user_present_all_index(`user_id`, `present_all_id`);
...
ALTER TABLE `user_sessions` ADD INDEX user_id_index(`user_id`);
